...
import { ScanText, LayoutGrid, ArrowLeft, Upload, FileText, Loader2, CheckCircle, AlertCircle, MessageSquare, Send, Bot, Code, Book } from 'lucide-react'
            ...
            <div style={{ display: 'grid', gap: '3rem' }}>
                ...
                <section className="glass-panel" style={{ padding: '2.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                        <div style={{ background: 'rgba(99, 102, 241, 0.1)', padding: '0.75rem', borderRadius: '0.75rem' }}>
                            <ScanText size={24} color="#6366f1" />
                        </div>
                        <h3 style={{ fontSize: '1.5rem', fontWeight: 700 }}>DeepSeek OCR API</h3>
                    </div>

                    <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', lineHeight: '1.6' }}>
                        Görsellerden yüksek doğrulukla metin çıkarımı yapar. Türkçe karakter desteği ve karmaşık düzen analizi içerir.
                    </p>
                    ...
                    <div style={{ marginBottom: '2rem' }}>
                        ...
                        <ul style={{ listStyle: 'none', padding: 0, marginBottom: '1.5rem' }}>
                            <li style={{ padding: '0.75rem', borderBottom: '1px solid var(--border-color)', display: 'flex', gap: '1rem' }}>
                                ...
                                <span style={{ color: 'var(--text-secondary)' }}>Görsel dosyası (Multipart Form Data)</span>
                            </li>
                        </ul>
                    </div>
...
print(response.json())`}
                ...
                <section className="glass-panel" style={{ padding: '2.5rem' }}>
                    <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '2rem' }}>
                        ...
                        <h3 style={{ fontSize: '1.5rem', fontWeight: 700 }}>İflas OCR Pipeline</h3>
                    </div>

                    <p style={{ color: 'var(--text-secondary)', marginBottom: '1.5rem', lineHeight: '1.6' }}>
                        Gazete ilanlarından yapılandırılmış veri (TCKN, VKN, Adres vb.) çıkarır. DeepSeek OCR ve OpenAI GPT-4 modellerini zincirleme kullanır.
                    </p>
