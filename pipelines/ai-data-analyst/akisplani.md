Oncelikle kisi Gno veya GNO adinda bir kolonu bulunan tabloyu yukleyecek. Sen bu tabloda yer alan her farkli gno degerindeki hyperlinke gidiceksin daha sonra acilen web sitesinde metin butonuna tiklayacaksin we orada textwrapperin icerisindeki texti alicaksin. Bu text aslinda bir haber daha sonrasinda su promptu kullanarak open ai api den bir liste donduruceksin:
...
sonra elde ettigimiz verileri her marka icin ayri ayri yorumlatmamiz gerekiyor (belki bunun icin daha ekonomik bir yontem olabilir bilmiyorum) 
...
# GİRİŞ VERİLERİ:
- **Hedef Marka:** {{MARKA_ADI}}  *(Buraya döngüdeki marka adını inject edeceksin)*
- **Analiz Edilecek Metin:** {{METIN_ICERIGI}}
...
bu promptla da cevap bekliyicez ama unutma akis soyle olucak diyelim ki kullanici bir tablo veya csv yukledi Gno veya GNO adli kolona gidiceksin ve diyelim ki bir satirindaki hyperlinke ulastin daha sonrasinda o linke gittin text butonuna tiklayip textwrapperin icerisindeki haberin textini aldin sonra ilk promptumuzla analiz yapicaz {
    "brand": "String (Marka Adı - Title Case)",
    "headline": "String (Max 7 kelime - Noktalama yok)",
    "category": "String (Enum: B2B, CORP, PROD, SERV, EVENT, CSR)"
  }
bu verileri cikaricaz daha sonrasinda openai api ile bize dondurulen her marka icin ayri ayri su analizi yapicaz (2. prompt) {
  "sentiment": "String (Enum: Olumlu, Olumsuz, Nötr)",
  "mention_weight": "String (Enum: Yüksek Bahis, Dengeli Bahis, Kısa Bahis)",
  "control": "String (Enum: Kontrollü, Kontrolsüz)"
}
ve bu verileri dondurucek bize sonra her marka icin ayri ayri bu verileri satirlarda suana kadar iki promptta da dondurdugumuz veriler ve cevaplariyla saklayacagiz ve en basta GNO olarak tablo haline getiricez iligli haberin gnosu yani her markanin analizinde ilgili haberle beaber verileri yer alicaz. Unutma kisinin yukleyecegi tabloda farkli farkli gnolar olabilir o yuzden bu islemi her farkli gno icin gerceklestiricez kisinin yukledigi tabloda gno "Gno" veya "GNO" seklinde geciyor olabilir.
